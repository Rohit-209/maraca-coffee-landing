...
export default function Pour() {
  ...
  return (
    <section
      ref={ref}
      className="relative min-h-[180vh] bg-cream-light grain overflow-hidden"
      id="story"
    >
      <div className="sticky top-0 h-screen flex items-center">
        <div className="max-w-7xl mx-auto px-6 lg:px-10 w-full grid lg:grid-cols-2 gap-12 items-center">
          <motion.div style={{ x: headlineX }}>
            <span className="inline-block text-xs uppercase tracking-[0.25em] text-mocha-dark/70 mb-6">
              02 — The Pour
            </span>
            <h2 className="font-display text-5xl lg:text-7xl leading-[1.02] tracking-tight text-espresso font-medium text-balance">
              A ritual, <br />
              <span className="italic text-mocha">not a routine.</span>
            </h2>
            <p className="mt-8 text-lg text-mocha-dark/80 max-w-md leading-relaxed">
              We bloom for forty-five seconds. Pour in slow concentric circles.
              Let the grounds breathe before the second pour. The result is a
              cup that rewards the patience it asked for.
            </p>

            <ul className="mt-10 space-y-3 text-mocha-dark">
              {[
          ...
          <div className="relative h-[600px] flex items-end justify-center">
            <svg width="320" height="120" viewBox="0 0 320 120" className="absolute top-20 left-1/2 -translate-x-1/2">
              <defs>
            ...
            <motion.div
              className="absolute top-[140px] left-1/2 -translate-x-1/2 w-[3px] bg-gradient-to-b from-mocha to-espresso rounded-full origin-top"
